        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionId = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttributeId2 = table.Column<int>(type: "int", nullable: true),
                    Created = table.Column<double>(type: "float", nullable: false),
                    LastModified = table.Column<double>(type: "float", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductSkus_ProductAttribute_AttributeId1",
                        column: x => x.AttributeId1,
                        principalTable: "ProductAttribute",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductSkus_ProductAttribute_AttributeId2",
                        column: x => x.AttributeId2,
                        principalTable: "ProductAttribute",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BasketItems_ProductSkus_ProductSkuId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasketItems_ProductSkuId",
                table: "BasketItems",
                column: "ProductSkuId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSkus_AttributeId1",
                table: "ProductSkus",
                column: "AttributeId1");

            migrationBuilder.CreateIndex(
                name: "IX_ProductSkus_AttributeId2",
                table: "ProductSkus",
                column: "AttributeId2");
